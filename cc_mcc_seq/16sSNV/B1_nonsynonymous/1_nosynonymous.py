dict1=dict()
inFile=open('sum_snv16s.exome_summary.DP.filter')
for line in inFile :
    line=line.strip()
    fields=line.split('\t')
    k='\t'.join(fields[21:26])
...
nonynonymous('SNV.exome.somatic.CHC5',dict1)
nonynonymous('SNV.exome.somatic.CHC6',dict1)
nonynonymous('SNV.exome.somatic.CHC7',dict1)
nonynonymous('SNV.exome.somatic.CHC10',dict1)
