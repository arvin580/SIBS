dict1=dict()
inFile=open('sum_indel.exome_combined')
ouFile=open('sum_indel.exome_combined.sorted','w')
...
dict1=dict()
inFile=open('sum_indel.genome_combined')
ouFile=open('sum_indel.genome_combined.sorted','w')
head=inFile.readline()
for line in inFile :
    line=line.strip()
    fields=line.split('\t')
