data=read.table('sum_indel.exome_combined.sorted.pass012.new.genesorted.tpvalue.0.05.2_c',sep='\t',header=F,row.names=1)
...
library(gplots)
pdf('sum_indel.exome_combined.sorted.pass012.new.genesorted.tpvalue.0.05.2_c.pdf')
