...
ouFile1=open('sum_indel.exome_combined.sorted.pass012.new.gene_ttest.pathway1','w')
ouFile2=open('sum_indel.exome_combined.sorted.pass012.new.gene_ttest.pathway2','w')
