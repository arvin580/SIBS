data=read.table('sum_snp.exome_combined.sorted.pass012.new.nonsyn.gene_ttest.pathway2_out',sep='\t',header=F,row.names=2)
...
library(gplots)
pdf('sum_snp.exome_combined.sorted.pass012.new.nonsyn.gene_ttest.pathway2_out.pdf')
