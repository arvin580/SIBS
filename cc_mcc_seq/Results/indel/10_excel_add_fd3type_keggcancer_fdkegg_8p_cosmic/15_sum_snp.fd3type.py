...
inFile1=open('sum_indel.exome_combined.sorted.pass012.new.genesorted.tpvalue')
ouFile1=open('sum_indel.exome_combined.sorted.pass012.new.genesorted.tpvalue.fd3type','w')
