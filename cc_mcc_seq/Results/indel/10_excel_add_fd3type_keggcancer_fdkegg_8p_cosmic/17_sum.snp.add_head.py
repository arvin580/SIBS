...
inFile=open('sum_indel.exome_combined.sorted.pass012.new.genesorted.tpvalue.fd3type.keggcancer.fdkegg.8p.cancercensus')
ouFile=open('sum_indel.exome_combined.sorted.pass012.new.genesorted.tpvalue.fd3type.keggcancer.fdkegg.8p.cancercensus.head','w')
