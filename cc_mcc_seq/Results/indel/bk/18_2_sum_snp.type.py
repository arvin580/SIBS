...
dict1=dict()
dict2=dict()
inFile=open('sum_snp.genome_combined.sorted.pass012.new.type2')
for line in inFile :
    line=line.strip('\r\n')
    fields=line.split('\t')
...
type3=['genomic','exonic','intronic','UTR','ncRNA','intergenic']
...
ouFile=open('sum_snp.genome_combined.sorted.pass012.new.type.stat','w')
ouFile.write('genomic\texonic\tintronic\tUTR\tncRNA\tintergenic\n')
...
plt.savefig('sum_snp.genome_combined.sorted.pass012.new.type.pdf')
