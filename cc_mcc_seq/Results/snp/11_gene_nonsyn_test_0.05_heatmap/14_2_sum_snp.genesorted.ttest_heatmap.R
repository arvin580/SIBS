data=read.table('sum_snp.exome_combined.sorted.pass012.new.nonsyn.genesorted.tpvalue.0.05.2_c',sep='\t',header=F,row.names=1)
...
library(gplots)
pdf('sum_snp.exome_combined.sorted.pass012.new.nonsyn.genesorted.tpvalue.0.05.2_c.pdf')
