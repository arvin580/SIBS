...
inFile=open('sum_snp.exome_combined.sorted')
ouFile=open('sum_snp.exome_combined.sorted.pass012','w')
...
inFile=open('sum_snp.genome_combined.sorted')
ouFile=open('sum_snp.genome_combined.sorted.pass012','w')
