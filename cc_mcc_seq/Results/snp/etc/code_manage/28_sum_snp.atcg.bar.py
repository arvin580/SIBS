...
### plot four ig into one, need modification
dict1=dict()
dict2=dict()
inFile=open('sum_snp.genome_combined.sorted.pass012.new.atcg.genome')
for line in inFile :
    line=line.strip('\r\n')
    fields=line.split('\t')
...
dict1=dict()
dict2=dict()
inFile=open('sum_snp.genome_combined.sorted.pass012.known.atcg.genome')
for line in inFile :
    line=line.strip('\r\n')
    fields=line.split('\t')
    dict1[fields[0]]=[int(i) for i in fields[1:11]]
...
dict1=dict()
dict2=dict()
inFile=open('sum_snp.genome_combined.sorted.pass012.known.atcg.exome')
for line in inFile :
    line=line.strip('\r\n')
    fields=line.split('\t')
    dict1[fields[0]]=[int(i) for i in fields[1:11]]
