...
p0 = ax.bar(ind, hunMean[type4[0]],   width, color='r', yerr=hunStd[type4[0]])
p1 = ax.bar(ind+width, hunMean[type4[1]],   width, color='y', yerr=hunStd[type4[1]])
p2 = ax.bar(ind+2*width, hunMean[type4[2]],   width, color='b', yerr=hunStd[type4[2]])
p3 = ax.bar(ind+3*width, hunMean[type4[3]],   width, color='g', yerr=hunStd[type4[3]])
#p4 = ax.bar(ind+4*width, hunMean[type4[4]],   width, color='c', yerr=hunStd[type4[4]])
...
plt.savefig('sum_snp.genome_combined.sorted.pass012.new.atcg.genome3.pdf')
