...
z=10
p0 = ax.bar(ind, danMean[type4[0]],z,width=width,zdir='y',color='r')
p1 = ax.bar(ind+width, danMean[type4[1]],z,width=width,zdir='y', color='y')
p2 = ax.bar(ind+2*width, danMean[type4[2]],z,width=width,zdir='y', color='b')
p3 = ax.bar(ind+3*width, danMean[type4[3]],z,width=width,zdir='y', color='g')
p4 = ax.bar(ind+4*width, danMean[type4[4]],z,width=width,zdir='y', color='c')

z=20
p0 = ax.bar(ind, hunMean[type4[0]],z,width=width,zdir='y',color='r')
p1 = ax.bar(ind+width, hunMean[type4[1]],z,width=width,zdir='y', color='y')
p2 = ax.bar(ind+2*width, hunMean[type4[2]],z,width=width,zdir='y', color='b')
p3 = ax.bar(ind+3*width, hunMean[type4[3]],z,width=width,zdir='y', color='g')
p4 = ax.bar(ind+4*width, hunMean[type4[4]],z,width=width,zdir='y', color='c')



plt.savefig('sum_snp.genome_combined.sorted.pass012.new.atcg.genome4.pdf')
...
plt.savefig('sum_snp.genome_combined.sorted.pass012.known.atcg.genome2.pdf')
