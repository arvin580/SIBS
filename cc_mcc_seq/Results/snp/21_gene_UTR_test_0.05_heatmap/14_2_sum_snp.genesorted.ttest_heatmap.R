data=read.table('sum_snp.genome_combined.sorted.pass012.new.UTR.genesorted.tpvalue.0.05.2_c',sep='\t',header=F,row.names=1)
...
library(gplots)
pdf('sum_snp.genome_combined.sorted.pass012.new.UTR.genesorted.tpvalue.0.05.2_c.pdf')
