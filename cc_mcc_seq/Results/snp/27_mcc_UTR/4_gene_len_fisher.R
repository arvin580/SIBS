data=read.table('sum_snp.exome_combined.sorted.pass012.new_mcc_num_len')
write.table(NA,'sum_snp.exome_combined.sorted.pass012.new_mcc_num_len_fisher',append=F,sep='\t',row.names=F,col.names=F,quote=F)
