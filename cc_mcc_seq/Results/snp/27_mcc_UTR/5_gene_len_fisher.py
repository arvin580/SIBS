...
ouFile=open('sum_snp.genome_combined.sorted.pass012.new.UTR.genesorted_mcc_num_len2_fisher','w')
ouFile2=open('sum_snp.genome_combined.sorted.pass012.new.UTR.genesorted_mcc_num_len2_fisher2','w')
