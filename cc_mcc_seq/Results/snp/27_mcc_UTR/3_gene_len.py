import re
inFile=open('/netshare1/home1/people/hansun/Data/hg19_refGene/hg19_refGene_utr_max_len')
...
dict2=dict()
inFile=open('sum_snp.genome_combined.sorted.pass012.new.UTR.genesorted_mcc')
ouFile=open('sum_snp.genome_combined.sorted.pass012.new.UTR.genesorted_mcc_num_len2','w')
