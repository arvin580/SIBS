...
dict2=dict()
inFile=open('sum_snp.genome_combined.sorted.pass012.new.UTR.genesorted_cc')
ouFile=open('sum_snp.genome_combined.sorted.pass012.new.UTR.genesorted_cc_num_len2','w')
