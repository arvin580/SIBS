import re
inFile=open('/netshare1/home1/people/hansun/Data/hg19_refGene/hg19_refGene_exon_max_len')
...
dict2=dict()
inFile=open('sum_snp.exome_combined.sorted.pass012.new_cc')
ouFile=open('sum_snp.exome_combined.sorted.pass012.new_cc_num_len2','w')
