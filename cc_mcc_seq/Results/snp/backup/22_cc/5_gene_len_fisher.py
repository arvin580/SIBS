...
ouFile=open('sum_snp.exome_combined.sorted.pass012.new_cc_num_len2_fisher','w')
ouFile2=open('sum_snp.exome_combined.sorted.pass012.new_cc_num_len2_fisher2','w')
