...
inFile2=open('sum_snp.genome_combined.sorted.pass012.new.UTR.genesorted.tpvalue.fd3type.keggcancer')
ouFile1=open('sum_snp.genome_combined.sorted.pass012.new.UTR.genesorted.tpvalue.fd3type.keggcancer.fdkegg','w')
