...
inFile1=open('sum_snp.genome_combined.sorted.pass012.new.UTR.genesorted.tpvalue')
ouFile1=open('sum_snp.genome_combined.sorted.pass012.new.UTR.genesorted.tpvalue.fd3type','w')
