...
inFile = open('delly.1.sv.stat.exon.symbol')
for line in inFile:
    line = line.strip()
    fields = line.split('\t')
...
inFile = open('jumpy.1.sv.stat.exon.symbol')
for line in inFile:
    line = line.strip()
    fields = line.split('\t')
...
inFile = open('invy.1.sv.stat.exon.symbol')
for line in inFile:
    line = line.strip()
    fields = line.split('\t')
...
inFile = open('duppy.1.sv.stat.exon.symbol')
for line in inFile:
    line = line.strip()
    fields = line.split('\t')
