...
files = ['invy.1.sv.stat.exon.symbol','jumpy.1.sv.stat.exon.symbol','duppy.1.sv.stat.exon.symbol']
def gene_heatmap(sampleNameList,ouF,figsize=0,rowList=[]):
    ...
    ouFile = open('invy.jumpy.duppy.1.sv.stat.exon.symbol.heatmap','w') 
    ouFile2 = open('invy.jumpy.duppy.1.sv.stat.exon.symbol.heatmap2','w') 
    for k in D : 
...
gene_heatmap(['ICC1A','ICC2A','ICC3A','ICC4A','ICC5A','ICC6A','ICC7A','ICC8A','ICC9A','ICC10A','CHC1A','CHC2A','CHC3A','CHC4A','CHC5A','CHC6A','CHC7A','CHC8A','CHC9A','CHC10A'],'invy.jumpy.duppy.exon.heatmap.pdf')
