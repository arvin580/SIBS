...
gene_significant_mutated('SNV.genome.somatic.exome.UTR.nondbsnp.geneLevel',[-8,-7,-6,-5],'ICC')
gene_significant_mutated('SNV.genome.somatic.exome.UTR.nondbsnp.geneLevel',[-4,-3,-2,-1],'CHC')
gene_significant_mutated('SNV.genome.somatic.exome.UTR.nondbsnp.geneLevel',[-8,-7,-6,-5,-4,-3,-2,-1],'ICC_CHC')
