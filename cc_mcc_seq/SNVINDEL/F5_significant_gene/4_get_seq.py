...
add_seq('SNV.genome.somatic.exome.UTR.nondbsnp.geneLevel.ICC.fisher_test.sorted.mutation')
add_seq('SNV.genome.somatic.exome.UTR.nondbsnp.geneLevel.CHC.fisher_test.sorted.mutation')
add_seq('SNV.genome.somatic.exome.UTR.nondbsnp.geneLevel.ICC_CHC.fisher_test.sorted.mutation')
