...
inFile=open('SNV.genome.somatic.exome.UTR.nondbsnp.geneLevel.ranksum_test.mutation')
ouFile=open('SNV.genome.somatic.exome.UTR.nondbsnp.geneLevel.ranksum_test.mutation_seq','w')
for line in inFile :
    line=line.strip()
    fields=line.split('\t')
    chrom=fields[1]
