...
combine_single(['INDEL.exome.somatic.ICC4','INDEL.exome.somatic.ICC5','INDEL.exome.somatic.ICC9','INDEL.exome.somatic.ICC10','INDEL.exome.somatic.CHC5','INDEL.exome.somatic.CHC6','INDEL.exome.somatic.CHC7','INDEL.exome.somatic.CHC10'],'INDEL.exome.somatic')
combine_single(['INDEL.genome.somatic.ICC4','INDEL.genome.somatic.ICC5','INDEL.genome.somatic.ICC9','INDEL.genome.somatic.ICC10','INDEL.genome.somatic.CHC5','INDEL.genome.somatic.CHC6','INDEL.genome.somatic.CHC7','INDEL.genome.somatic.CHC10'],'INDEL.genome.somatic')
