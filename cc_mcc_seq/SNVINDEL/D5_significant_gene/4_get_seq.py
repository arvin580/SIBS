...
add_seq('SNV.exome.somatic.nonsynonymous_nondbsnp.geneLevel.ICC.fisher_test.sorted.mutation')
add_seq('SNV.exome.somatic.nonsynonymous_nondbsnp.geneLevel.CHC.fisher_test.sorted.mutation')
add_seq('SNV.exome.somatic.nonsynonymous_nondbsnp.geneLevel.ICC_CHC.fisher_test.sorted.mutation')
