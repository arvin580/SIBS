...
#gene_significant_mutated('SNV.exome.somatic.nonsynonymous_nondbsnp.geneLevel',[-8,-7,-6,-5],'ICC')
gene_significant_mutated('SNV.exome.somatic.nonsynonymous_nondbsnp.geneLevel',[-4,-3,-2,-1],'CHC')
#gene_significant_mutated('SNV.exome.somatic.nonsynonymous_nondbsnp.geneLevel',[-8,-7,-6,-5,-4,-3,-2,-1],'ICC_CHC')
