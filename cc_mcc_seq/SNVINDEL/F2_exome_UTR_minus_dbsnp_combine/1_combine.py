...
combine_single(['SNV.genome.somatic.ICC4.exome.UTR.nondbsnp','SNV.genome.somatic.ICC5.exome.UTR.nondbsnp','SNV.genome.somatic.ICC9.exome.UTR.nondbsnp','SNV.genome.somatic.ICC10.exome.UTR.nondbsnp','SNV.genome.somatic.CHC5.exome.UTR.nondbsnp','SNV.genome.somatic.CHC6.exome.UTR.nondbsnp','SNV.genome.somatic.CHC7.exome.UTR.nondbsnp','SNV.genome.somatic.CHC10.exome.UTR.nondbsnp'],'SNV.genome.somatic.exome.UTR.nondbsnp')
