...
add_seq('SNV.exome.somatic.nonsynonymous.geneLevel.ICC.fisher_test.sorted.mutation')
add_seq('SNV.exome.somatic.nonsynonymous.geneLevel.CHC.fisher_test.sorted.mutation')
add_seq('SNV.exome.somatic.nonsynonymous.geneLevel.ICC_CHC.fisher_test.sorted.mutation')
