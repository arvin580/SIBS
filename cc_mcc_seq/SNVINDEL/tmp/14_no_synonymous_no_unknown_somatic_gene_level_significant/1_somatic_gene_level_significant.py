...
#gene_significant_mutated('sum_snp.exome_summary.pass012.nonsynonymous.somatic.gene_level',[-8,-7,-6,-5],'ICC')
gene_significant_mutated('sum_snp.exome_summary.pass012.nonsynonymous.somatic.gene_level',[-4,-3,-2,-1],'CHC')
