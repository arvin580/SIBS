...
snv_distribution_table(['SNV.genome.somatic.ICC4.new.dist','SNV.genome.somatic.ICC5.new.dist','SNV.genome.somatic.ICC9.new.dist','SNV.genome.somatic.ICC10.new.dist','SNV.genome.somatic.CHC5.new.dist','SNV.genome.somatic.CHC6.new.dist','SNV.genome.somatic.CHC7.new.dist','SNV.genome.somatic.CHC10.new.dist'],['ICC4','ICC5','ICC9','ICC10','CHC5','CHC6','CHC7','CHC10'],'SNV.genome.new.somatic.distribution.formated')
