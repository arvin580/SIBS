...
combine_single(['SNV.exome.somatic.ICC4','SNV.exome.somatic.ICC5','SNV.exome.somatic.ICC9','SNV.exome.somatic.ICC10','SNV.exome.somatic.CHC5','SNV.exome.somatic.CHC6','SNV.exome.somatic.CHC7','SNV.exome.somatic.CHC10'],'SNV.exome.somatic')
combine_single(['SNV.genome.somatic.ICC4','SNV.genome.somatic.ICC5','SNV.genome.somatic.ICC9','SNV.genome.somatic.ICC10','SNV.genome.somatic.CHC5','SNV.genome.somatic.CHC6','SNV.genome.somatic.CHC7','SNV.genome.somatic.CHC10'],'SNV.genome.somatic')
