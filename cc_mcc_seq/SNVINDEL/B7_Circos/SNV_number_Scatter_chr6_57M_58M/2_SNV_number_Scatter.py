...
s=scatter_format(['SNV.genome.somatic.ICC4.sca'])
s=scatter_format(['SNV.genome.somatic.ICC5.sca'])
s=scatter_format(['SNV.genome.somatic.ICC9.sca'])
s=scatter_format(['SNV.genome.somatic.ICC10.sca'])
s=scatter_format(['SNV.genome.somatic.CHC5.sca'])
s=scatter_format(['SNV.genome.somatic.CHC6.sca'])
s=scatter_format(['SNV.genome.somatic.CHC7.sca'])
s=scatter_format(['SNV.genome.somatic.CHC10.sca'])
