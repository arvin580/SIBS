...
y=read_data(['SNV.genome.ICC4B.sca','SNV.genome.ICC5B.sca','SNV.genome.ICC9B.sca','SNV.genome.ICC10B.sca','SNV.genome.CHC5B.sca','SNV.genome.CHC6B.sca','SNV.genome.CHC7B.sca','SNV.genome.CHC10B.sca'])
...
plt.savefig('SNV_number_Scatter_chr8_0_45600000.normal.pdf')
