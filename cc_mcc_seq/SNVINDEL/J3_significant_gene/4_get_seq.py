...
add_seq('genome.somatic.exome.UTR.INDEL.nondbsnp.geneLevel.ICC.fisher_test.sorted.mutation')
add_seq('genome.somatic.exome.UTR.INDEL.nondbsnp.geneLevel.CHC.fisher_test.sorted.mutation')
add_seq('genome.somatic.exome.UTR.INDEL.nondbsnp.geneLevel.ICC_CHC.fisher_test.sorted.mutation')
