...
inFile=open('SNV.exome.somatic.nonsynonymous.geneLevel_pageranked.mutation')
ouFile=open('SNV.exome.somatic.nonsynonymous.geneLevel_pageranked.mutation_seq','w')
for line in inFile :
    line=line.strip()
    fields=line.split('\t')
    chrom=fields[1]
