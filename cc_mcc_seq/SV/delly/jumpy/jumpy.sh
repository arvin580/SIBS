cd /netshare1/home1/szzhongxin/proj1/hansun/SV/delly/jumpy
...
jumpy -z . -p -g $hg19 $ICC4A $ICC5A $ICC9A $ICC10A $CHC5A $CHC6A $CHC7A $CHC10A $ICC4B $ICC5B $ICC9B $ICC10B $CHC5B $CHC6B $CHC7B $CHC10B
