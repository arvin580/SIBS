...
combine_single(['INDEL.exome.somatic.ICC4.not.repeat.mc','INDEL.exome.somatic.ICC5.not.repeat.mc','INDEL.exome.somatic.ICC9.not.repeat.mc','INDEL.exome.somatic.ICC10.not.repeat.mc','INDEL.exome.somatic.CHC5.not.repeat.mc','INDEL.exome.somatic.CHC6.not.repeat.mc','INDEL.exome.somatic.CHC7.not.repeat.mc','INDEL.exome.somatic.CHC10.not.repeat.mc'],'INDEL.exome.somatic')
