cd /netshare1/home1/szzhongxin/proj1/hansun/samtools/SNV
...
samtools mpileup -uDf /netshare1/home1/people/hansun/GATK/bundle/ucsc.hg19.fasta -r $chr $ICC1A $ICC2A $ICC3A $ICC4A $ICC5A $ICC6A $ICC7A $ICC8A $ICC9A $ICC10A $CHC1A $CHC2A $CHC3A $CHC4A $CHC5A $CHC6A $CHC7A $CHC8A $CHC9A $CHC10A  $ICC4B $ICC5B $ICC9B $ICC10B $CHC5B $CHC6B $CHC7B $CHC10B | bcftools view -bvcg - > var.raw.${chr}.bcf
