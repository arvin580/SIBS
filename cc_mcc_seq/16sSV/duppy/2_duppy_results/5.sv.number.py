...
pp=PyPlot('duppy.number.pdf')
pp.multi_bar_vertical_sv_number(Data,legTitle=['Tumor','Normal'],xLabel=['ICC4','ICC5','ICC9','ICC10','CHC5','CHC6','CHC7','CHC10'],legX=0.95, legY=0.98)
