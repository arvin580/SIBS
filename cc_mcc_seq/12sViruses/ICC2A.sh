...
python 2.fq.py ICC2A.unmapped

read1fq=ICC2A.unmapped.fq
read1sai=ICC2A.unmapped.sai
bam=ICC2A.unmapped.bam
sam=ICC2A.unmapped.sam
...
$read1sai \
/netshare1/home1/szzhongxin/proj1/hansun/12sViruses/$read1fq \
-r "@RG\tID:2a\tSM:2a\tLB:2a\tPL:illumina\tPU:barcode" >$sam
