...
snv_pattern(['SNV.genome.somatic.ICC4.not.repeat','SNV.genome.somatic.ICC5.not.repeat','SNV.genome.somatic.ICC9.not.repeat','SNV.genome.somatic.ICC10.not.repeat','SNV.genome.somatic.CHC5.not.repeat','SNV.genome.somatic.CHC6.not.repeat','SNV.genome.somatic.CHC7.not.repeat','SNV.genome.somatic.CHC10.not.repeat'],['ICC4','ICC5','ICC9','ICC10','CHC5','CHC6','CHC7','CHC10'])
