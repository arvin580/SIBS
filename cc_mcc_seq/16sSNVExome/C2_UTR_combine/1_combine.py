...
combine_single(['SNV.genome.somatic.ICC4.not.repeat.mc.UTR','SNV.genome.somatic.ICC5.not.repeat.mc.UTR','SNV.genome.somatic.ICC9.not.repeat.mc.UTR','SNV.genome.somatic.ICC10.not.repeat.mc.UTR','SNV.genome.somatic.CHC5.not.repeat.mc.UTR','SNV.genome.somatic.CHC6.not.repeat.mc.UTR','SNV.genome.somatic.CHC7.not.repeat.mc.UTR','SNV.genome.somatic.CHC10.not.repeat.mc.UTR'],'SNV.genome.somatic.UTR')
