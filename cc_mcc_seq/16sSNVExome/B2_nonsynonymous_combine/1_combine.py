...
combine_single(['SNV.exome.somatic.ICC4.not.repeat.mc.nonsynonymous','SNV.exome.somatic.ICC5.not.repeat.mc.nonsynonymous','SNV.exome.somatic.ICC9.not.repeat.mc.nonsynonymous','SNV.exome.somatic.ICC10.not.repeat.mc.nonsynonymous','SNV.exome.somatic.CHC5.not.repeat.mc.nonsynonymous','SNV.exome.somatic.CHC6.not.repeat.mc.nonsynonymous','SNV.exome.somatic.CHC7.not.repeat.mc.nonsynonymous','SNV.exome.somatic.CHC10.not.repeat.mc.nonsynonymous'],'SNV.exome.somatic.nonsynonymous')
