...
unique('CosmicCodingMuts_v64_02042013_noLimit-indel.formated.pep.not-ref-alt-nonstop-KR-checked','INDEL')
unique('CosmicCodingMuts_v64_02042013_noLimit-indel.formated.pep.ref-alt-nonsynonymous-nonstop-KR-checked','INDEL')
...
ouFile = open('Homo_known-protein_snv_indel-KR','w')
for k in D:
