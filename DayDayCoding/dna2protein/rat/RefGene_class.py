...
class RefGene :
    ...
    def calculate_Coding_NoCoding_Intronic_Intergenic_Length(self) :
        ...
        ouFile=open('rn4.refGene.Coding_NoCoding_Intronic_Intergenic_Length','w')
...
,'chr15','chr16','chr17','chr18','chr19','chr20','chr21','chr22','chrX','chrY','chrM']
        ...
        inFile=open('rn4.refGene.Coding_NoCoding_Intronic_Intergenic_Length')
        ouFile=open('rn4.refGene.Coding_NoCoding_Intronic_Intergenic_Length.total','w')
