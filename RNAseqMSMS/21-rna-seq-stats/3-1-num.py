...
num('split-mapped-deletion.normal.seq.filtered2')
num('split-mapped-inversion.normal.seq.filtered2')
num('split-mapped-duplication.normal.seq.filtered2')
num('split-mapped-translocation.normal.seq.filtered2')
