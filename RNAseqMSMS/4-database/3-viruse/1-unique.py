...
unique('ERR0498-04-05.unmapped.unique.human-viruse.pep','HUMAN-VIRUS')
unique('unmapped-blated-viruses-90-60.seq.pep','VIRUS')

ouFile = open('Homo_known-protein_virus','w')
for k in D:
