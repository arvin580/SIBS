...
def chr_site(I):
    ouFile = open('ERR0498-04-05.unmapped.unique.human-viruse-checked-human-chr-site'+'-'+str(I),'w')
    ouFile2 = open('ERR0498-04-05.unmapped.unique.human-viruse-checked-human-chr-site'+'-'+str(I)+'-2','w')
    for ch in chs:
        #CHR = {}
