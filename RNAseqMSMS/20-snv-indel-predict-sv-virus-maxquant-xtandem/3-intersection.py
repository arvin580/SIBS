...
inFile = open('HeLa-variant-Trypsin-LysC-GluC-peptide-snv-indel-predict-sv-virus-gene-miss_cleavage-known_new-normal_check-spec-to_validation_not_predict-pFind3-pFind-ONE-UNIQUE-Trypsin')
for line in inFile:
    line = line.rstrip()
    fields = line.split('\t')
    pep = fields[9]
