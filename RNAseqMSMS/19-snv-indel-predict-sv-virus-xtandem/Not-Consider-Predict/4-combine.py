...
combine('HeLa-peptide-snv-indel-predict-sv-virus-trypsin-pep-not_predict')
combine('HeLa-peptide-snv-indel-predict-sv-virus-lysc-pep-not_predict')
combine('HeLa-peptide-snv-indel-predict-sv-virus-gluc-pep-not_predict')
