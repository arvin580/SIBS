...
#gene('HeLa-predict-rnaseq-msms-human-gene3')
gene('HeLa-SV-Deletion-pep.full-cleavage.gene.gene')
gene('HeLa-SV-Duplication-pep.full-cleavage.gene.gene')
gene('HeLa-SV-Inversion-pep.full-cleavage.gene.gene')
gene('HeLa-SV-Translocation-pep.full-cleavage.gene.gene')
