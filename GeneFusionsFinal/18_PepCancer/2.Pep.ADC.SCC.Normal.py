...
def deal(pep,D1) :
    inFile=open('Tandem.Omssa.FDR.pep.genefusions.final.pos.3.3.spec')
    for line in inFile :
        line=line.strip()
        fields=line.split()
        n1=int(fields[1])
...
ouFile=open('Tandem.Omssa.FDR.pep.genefusions.final.pos.3.3.spec2.num.tandem','w')
