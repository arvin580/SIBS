...
ouFile=open('Tandem.Omssa.FDR.pep.splicing.final.pos.3.3','w')
ouFile1=open('Tandem.not.Omssa.FDR.pep.splicing.final.pos.3.3','w')
ouFile2=open('Tandem.Omssa.not.FDR.pep.splicing.final.pos.3.3','w')
for key in D1 :
