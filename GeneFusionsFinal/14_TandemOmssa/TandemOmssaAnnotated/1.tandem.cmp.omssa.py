...
ouFile=open('Tandem.Omssa.FDR.pep.annotated.final','w')
ouFile1=open('Tandem.not.Omssa.FDR.pep.annotated.final','w')
ouFile2=open('Tandem.Omssa.not.FDR.pep.annotated.final','w')
for key in D1 :
